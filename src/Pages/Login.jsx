...
export default function Login() {
  return (
    <div className="h-screen flex items-center justify-center bg-background">
      <div className="flex flex-col md:flex-row w-full md:w-11/12 md:h-5/6  h-screen rounded-xl overflow-hidden  shadow-md ">
        <div className="flex-1 flex  justify-center items-center p-6 overflow-auto  bg-white">
          <Outlet />
        </div>
