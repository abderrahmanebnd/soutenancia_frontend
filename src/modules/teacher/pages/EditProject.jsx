...
const formSchema = z.object({
  ...
  teamNumbers: z
    .number()
    .min(2, { message: "Number of teams must be at least 2." })
    .max(9, { message: "Number of teams must not exceed 9." }),
...
function EditProject() {
  ...
  const onSubmit = (data) => {
    const updatedData = {
      ...
      assignmentType:
        data.assignMode === "Auto-Selection" ? "auto" : "teacherApproval",
      ...
      <div className="bg-white px-6 pt-6 lg:px-12 lg:pt-12 pb-6 rounded-xl shadow-lg w-full md:max-w-2xl space-y-6">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            />
            <p className="text-red-500">
              {form.formState.errors.projectSummary?.message}
            </p>
          </div>
          <div>
            <label className="block text-base text-primary">
              ...
              <Input
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    ...
                    if (
                      trimmedValue &&
                      !form.getValues("usedTechnologies").includes(trimmedValue)
                    ) {
                      form.setValue("usedTechnologies", [
                        ...form.getValues("usedTechnologies"),
                        trimmedValue,
                      ]);
                      setTechInput("");
                    }
            ...
            <p className="text-red-500">
              {form.formState.errors.usedTechnologies?.message}
            </p>
          </div>
          <div>
              ...
              <Input
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    ...
                    if (
                      trimmedValue &&
                      !form.getValues("usedTools").includes(trimmedValue)
                    ) {
                      form.setValue("usedTools", [
                        ...form.getValues("usedTools"),
                        trimmedValue,
                      ]);
                      setToolInput("");
                    }
            ...
            <p className="text-red-500">
              {form.formState.errors.usedTools?.message}
            </p>
          </div>
          <div>
            <label className="block text-base text-primary">
              ...
              <Input
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    ...
                    if (
                      trimmedValue &&
                      !form.getValues("destinatedFor").includes(trimmedValue)
                    ) {
                      form.setValue("destinatedFor", [
                        ...form.getValues("destinatedFor"),
                        trimmedValue,
                      ]);
                      setSpecialityInput("");
                    }
            ...
            <p className="text-red-500">
              {form.formState.errors.destinatedFor?.message}
            </p>
          </div>
          <div>
            ...
            />
            <p className="text-red-500">
              {form.formState.errors.teamNumbers?.message}
            </p>
          </div>
          <div>
            <label className="block text-base text-primary">Assign Mode</label>
            <Input
              {...form.register("assignMode")}
              placeholder="Enter assignment mode"
            />
            <p className="text-red-500">
              {form.formState.errors.assignMode?.message}
            </p>
          </div>
          <div>
            <label className="block text-base text-primary">
            ...
            <Input
              {...form.register("projectAttachments")}
              placeholder="Enter project attachments"
            />
            <p className="text-red-500">
              {form.formState.errors.projectAttachments?.message}
            </p>
          </div>
          <div>
            <label className="block text-base text-primary">
            ...
            <Input
              {...form.register("selectedFramers")}
              placeholder="Enter selected framers"
            />
            <p className="text-red-500">
              {form.formState.errors.selectedFramers?.message}
            </p>
          </div>
